...
<head>
  <title>CarkerID &mdash; Situs Pencari Kerja</title>
  <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-6 col-xl-2">
            <h1 class="mb-0"><a href="index.html" class="text-black h2 mb-0">Carker<strong>ID</strong></a></h1>
          </div>
            ...
            <nav class="site-navigation text-right" role="navigation">
              <ul class="site-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <?php if (Session::get('login') == false) {
                  ?>
                  <li><a href="{{url('/login')}}"><span class="rounded bg-primary py-2 px-3 text-white"><span class="h5 mr-2">+</span> Login</span></a></li>
                <?php } ?>
                <!-- Untuk Logout -->
        ...
        <div class="row justify-content-start text-left mb-5">
          ...
          <div class="col-md-3" data-aos="fade" data-aos-delay="200">
            ...
            <?php if (Session::get('akses') == 'admin') {
              ?>
              <a href="{{url('/postjob')}}" class="btn btn-primary py-3 btn-block"><span class="h5">+</span> Post a Job</a>
            <?php } ?>
            <!-- Akhir kodingan -->
          </div>
        </div>
